...
public class CosineWaveDrawer : MonoBehaviour
{
    ...
    void DrawCosineWave()
    {
        ...
        for (int i = 0; i < numberOfPoints; i++)
        {
            ...
            float y = Mathf.Cos(x * Mathf.PI * frequency / halfWaveWidth) * amplitude;
            ...
            float nextY = Mathf.Cos(nextX * Mathf.PI * frequency / halfWaveWidth) * amplitude;
